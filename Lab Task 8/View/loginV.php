...
<form name="myForm" action="../Controller/login.php" method="post" onsubmit="return validateForm()">
    ...
    <input type="text" placeholder="Enter ID" id="myName" onfocus="focusID()" onblur="blurID()" class="fadeIn second" name="userid">
    <span class="error">*</span>
    <p id="nameError"></p>
  <br>
    
    <input type="password" placeholder="Enter Password" id="myPsw" onfocus="focusPsw()" onblur="blurPsw()" class="fadeIn third" name="psw">
